...
const Form = () => {
    ...
    const {addTranscation} = useContext(ExpenseTrackerContext);
    const createTranscation = () => {
        const transcations = {...formData, amount: Number(formData.amount), id: uuidv4() }
    ...
    //Select category depending on income or expense
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Button className={classes.button} variant="contained" color="primary" fullWidth onClick={createTranscation}>Create</Button>
